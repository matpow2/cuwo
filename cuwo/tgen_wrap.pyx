...
cdef class WrapAppearanceData:
    ...
    def scale(self):
        ...
        cdef np.ndarray arr = PyArray_NewFromDescr(<PyTypeObject *>Vector3, dtype_float32, 1, &vec3_dim, NULL, <void*>ptr, np.NPY_DEFAULT, <object>NULL);
...
cdef class WrapEntityData:
    ...
    def pos(self):
        ...
        cdef np.ndarray arr = PyArray_NewFromDescr(<PyTypeObject *>Vector3, dtype_int64, 1, &vec3_dim, NULL, <void*>ptr, np.NPY_DEFAULT, <object>NULL);
        np.set_array_base(arr, self)
        return arr
    @pos.setter
    def pos(self, value):
    ...
    def start_chunk(self):
        ...
        cdef np.ndarray arr = PyArray_NewFromDescr(<PyTypeObject *>Vector3, dtype_int32, 1, &vec3_dim, NULL, <void*>ptr, np.NPY_DEFAULT, <object>NULL);
        np.set_array_base(arr, self)
        return arr
    @start_chunk.setter
