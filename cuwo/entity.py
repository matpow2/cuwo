...
class EquipmentExtra(Loader):
    def read(self, reader):
        self.something = reader.read_int8()
        self.distancesomething = reader.read_int8()
        self.something3 = reader.read_int8()
        self.something4 = reader.read_int8()
        self.something5 = reader.read_uint32()
    
    def write(self, writer):
        writer.write_int8(self.something)
        writer.write_int8(self.distancesomething)
        writer.write_int8(self.something3)
        writer.write_int8(self.something4)
...
class EquipmentData(Loader):
    def read(self, reader):
        ...
        self.pow_val = reader.read_uint8()
        self.special_add = reader.read_uint8()
        self.byteE = reader.read_uint8()
        reader.skip(1)
        self.add_val = reader.read_uint16()
        reader.skip(2)
        self.items = []
        for _ in xrange(32):
        ...
        self.dword114 = reader.read_uint32()
    ...
    def write(self, writer):
        ...
        writer.write_uint8(self.pow_val)
        writer.write_uint8(self.special_add)
        writer.write_uint8(self.byteE)
        writer.pad(1)
        writer.write_uint16(self.add_val)
        writer.pad(2)
        for item in self.items:
            item.write(writer)
        writer.write_uint32(self.dword114)
